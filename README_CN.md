...
- [2025-03-05] 🎉 **祝贺!** 🎉
  ...
  VenusHub系列的最新成果**VenusMutHub**被Acta Pharmaceutica Sinica B正式接收!     
  在本研究中，我们构建了 **900+ 高质量基准数据集**，涵盖 **500+ 不同功能特性的蛋白质**. VenusMutHub为蛋白质突变效应预测提供了前所未有的全面评估体系。不仅填补了现有基准数据集在多样性和挑战性方面的空白，更为模型的**泛化能力,稳健性和实际应用价值**提供了更加严格的测试标准。 🚀💡

  🔗 **相关链接:**  
  - 📄 [**文章**](https://www.sciencedirect.com/science/article/pii/S2211383525001650)  
  - 📊 [**数据集**](https://huggingface.co/datasets/AI4Protein/VenusMutHub)  
  - 🏆 [**排行榜**](https://lianglab.sjtu.edu.cn/muthub/)
